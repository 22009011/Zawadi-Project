...
//       if (selectedClass) {
//         try {
//           const response = await axios.get(`http://localhost:5000/api/students?class_id=${selectedClass}`);
...
//       try {
//         const response = await axios.get('http://localhost:5000/api/allassessments');
...
//       await axios.post('http://localhost:5000/api/allassessments', assessmentData);
